...
/*!***********************!*\
  ...
  \***********************/
/*! namespace exports */
/*! export MODE_FIND_MONSTER_THEN [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export MODE_IF_FREE [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export MODE_MACRO [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export MODE_NULL [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export MODE_RUN_UNLESS_FREE [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export Macro [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export adventureIfFree [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export adventureKill [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export adventureMacro [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export adventureMode [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export adventureRunUnlessFree [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export findMonsterSaberYr [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export findMonsterThen [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export getArg1 [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export getArg2 [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export getMacroId [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export getMode [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export main [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export saberYr [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! export setMode [provided] [maybe used in hccs_combat (runtime-defined)] [usage prevents renaming] */
/*! other exports [not provided] [maybe used in hccs_combat (runtime-defined)] */
...
/* harmony export */   "MODE_IF_FREE": () => /* binding */ MODE_IF_FREE,
...
/* harmony export */   "adventureIfFree": () => /* binding */ adventureIfFree
/* harmony export */ });
...
function _templateObject4() {
  var data = _taggedTemplateLiteral(["Detect Weakness"]);
...
var Macro = /*#__PURE__*/function () {
  ...
  _createClass(Macro, [{
    ...
    value: function setAutoAttack() {
      if (Macro.cachedMacroId !== null && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getAutoAttack)() === 99000000 + Macro.cachedMacroId && Macro.cachedAutoAttack !== null && this.toString() === Macro.cachedAutoAttack.toString()) {
      ...
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("account.php?am=1&action=autoattack&value=99".concat(Macro.cachedMacroId, "&ajax=1"));
    }
  }, {
    key: "abort",
    ...
    key: "kill",
    value: function kill() {
      return this.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject2())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject3())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject4())).mWhile('!match "some of it is even intact" && !mpbelow 50 && !hpbelow 100', Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject5()))).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject6())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject7())).skillRepeat((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject8())).attack();
    }
  }, {
    key: "freeKill",
    value: function freeKill() {
      return Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject9())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject10())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject11())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject12())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject13()));
    }
  }], [{
    key: "step",
    value: function step() {
    ...
    value: function freeRun() {
      return new Macro().externalIf((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject14())) && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effect)(_templateObject15())) > 0 || (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$familiar)(_templateObject16())), 'runaway').skills((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skills)(_templateObject17())).items((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject18())).abort();
    }
  }]);
...
function setMode(mode) {
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setProperty)('hccs_combatMode', mode);
  if (arg1 !== null) (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setProperty)('hccs_combatArg1', arg1);
  if (arg2 !== null) (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setProperty)('hccs_combatArg2', arg2);
}
function getMode() {
  return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)('hccs_combatMode');
}
function getArg1() {
  return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)('hccs_combatArg1');
}
function getArg2() {
  return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)('hccs_combatArg2');
}
...
var freeRunItems = (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject19());
function main(initround, foe) {
  var mode = getMode();
  var loc = (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myLocation)();
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("foe: ".concat(foe));
  ...
  if (mode === MODE_MACRO) {
    ...
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.print)("current: ".concat(foe, ", desired: ").concat(desired));

    if (foe === desired) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setProperty)('hccs_combatFound', 'true');
      new Macro().step(getArg2()).repeatSubmit();
    } else if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myMp)() >= 50 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveSkill)(Skill.get('Snokebomb')) && (0,_lib__WEBPACK_IMPORTED_MODULE_2__.getPropertyInt)('_snokebombUsed') < 3 && !usedBanisherInZone(banished, 'snokebomb', loc)) {
    ...
    } else if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveSkill)(Skill.get('Macrometeorite')) && (0,_lib__WEBPACK_IMPORTED_MODULE_2__.getPropertyInt)('_macrometeoriteUses') < 10) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useSkill)(1, Skill.get('Macrometeorite'));
    } else if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveSkill)(Skill.get('CHEAT CODE: Replace Enemy')) && (0,_lib__WEBPACK_IMPORTED_MODULE_2__.getPropertyInt)('_powerfulGloveBatteryPowerUsed') <= 80) {
    ...
    if (foe.attributes.includes('FREE')) {
    ...
    } else if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myFamiliar)() === Familiar.get('Frumious Bandersnatch') && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEffect)(Effect.get('Ode to Booze')) > 0 && (0,_lib__WEBPACK_IMPORTED_MODULE_2__.getPropertyInt)('_banderRunaways') < (0,_lib__WEBPACK_IMPORTED_MODULE_2__.myFamiliarWeight)() / 5) {
      ...
      return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.itemAmount)(it) > 0;
    })) {
      Macro.item(freeRunItems.find(function (it) {
        return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.itemAmount)(it) > 0;
      })).repeatSubmit();
    } else {
      // non-free, whatever
...
function findMonsterThen(loc, foe, macro) {
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setProperty)('hccs_combatFound', 'false');

  try {
    while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)('hccs_combatFound') !== 'true') {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.adv1)(loc, -1, '');
    }
  } finally {
    setMode(MODE_NULL, '');
...
function adventureIfFree(loc, macroIfFree, macroIfNotFree) {
...
/*!**********************!*\
  ...
  \**********************/
/*! namespace exports */
/*! exports [not provided] [maybe used in hccs (runtime-defined)] */
...
/* harmony import */ var libram_src__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! libram/src */ "./node_modules/libram/src/index.ts");
...
/* harmony import */ var _synthesis__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./synthesis */ "./src/synthesis.ts");
...
function _templateObject508() {
  var data = _taggedTemplateLiteral(["Yeg's Motel hand soap"]);
...
function _templateObject494() {
  var data = _taggedTemplateLiteral(["Staff of Simmering Hatred"]);
...
function _templateObject486() {
  var data = _taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]);
...
function _templateObject481() {
  var data = _taggedTemplateLiteral(["Outer Wolf"]);
...
function _templateObject480() {
  var data = _taggedTemplateLiteral(["red eye"]);
...
function _templateObject479() {
  var data = _taggedTemplateLiteral(["Seeing Red"]);
...
function _templateObject478() {
  var data = _taggedTemplateLiteral(["wasabi marble soda"]);
...
function _templateObject477() {
  var data = _taggedTemplateLiteral(["Wasabi With You"]);
...
function _templateObject464() {
  var data = _taggedTemplateLiteral(["Weapon of Mass Destruction"]);
...
function _templateObject463() {
  var data = _taggedTemplateLiteral(["goofily-plumed helmet"]);
...
function _templateObject443() {
  var data = _taggedTemplateLiteral(["Elbow Sauce"]);
...
function _templateObject435() {
  var data = _taggedTemplateLiteral(["Great Wolf's beastly trousers"]);
...
function _templateObject412() {
  var data = _taggedTemplateLiteral(["Disquiet Riot"]);
...
function _templateObject410() {
  var data = _taggedTemplateLiteral(["Become Superficially Interested"]);
...
function _templateObject394() {
  var data = _taggedTemplateLiteral(["infernal snowball"]);
...
function _templateObject393() {
  var data = _taggedTemplateLiteral(["Good Chance of Surviving Hell"]);
...
function _templateObject392() {
  var data = _taggedTemplateLiteral(["SPF 451 lip balm"]);
...
function _templateObject391() {
  var data = _taggedTemplateLiteral(["Fireproof Lips"]);
...
function _templateObject385() {
  var data = _taggedTemplateLiteral(["Driving Safely"]);
...
function _templateObject340() {
  var data = _taggedTemplateLiteral(["Infernal Thirst"]);
...
function _templateObject334() {
  var data = _taggedTemplateLiteral(["cyclops eyedrops"]);
...
function _templateObject333() {
  var data = _taggedTemplateLiteral(["One Very Clear Eye"]);
...
function _templateObject309() {
  var data = _taggedTemplateLiteral(["Synthesis: Cool"]);
...
function _templateObject264() {
  var data = _taggedTemplateLiteral(["Power Ballad of the Arrowsmith"]);
...
function _templateObject255() {
  var data = _taggedTemplateLiteral(["Synthesis: Strong"]);
...
function _templateObject215() {
  var data = _taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]);
...
function _templateObject203() {
  var data = _taggedTemplateLiteral(["Driving Recklessly"]);
...
function _templateObject167() {
  var data = _taggedTemplateLiteral(["novelty tropical skeleton"]);
...
function _templateObject166() {
  var data = _taggedTemplateLiteral(["The Skeleton Store"]);
...
function _templateObject160() {
  var data = _taggedTemplateLiteral(["cherry"]);
...
function _templateObject157() {
  var data = _taggedTemplateLiteral(["grapefruit"]);
...
function _templateObject151() {
  var data = _taggedTemplateLiteral(["Hugs and Kisses!"]);
...
function _templateObject148() {
  var data = _taggedTemplateLiteral(["XO Skeleton"]);
...
function _templateObject147() {
  var data = _taggedTemplateLiteral(["tiny black hole"]);
...
function _templateObject144() {
  var data = _taggedTemplateLiteral(["Springy Fusilli"]);
...
function _templateObject126() {
  var data = _taggedTemplateLiteral(["Hawking's Elixir of Brilliance"]);
...
function _templateObject122() {
  var data = _taggedTemplateLiteral(["BRICKO pearl"]);
...
function _templateObject67() {
  var data = _taggedTemplateLiteral(["Flaskfull of Hollow"]);
...
function _templateObject22() {
  var data = _taggedTemplateLiteral(["Synthesis: Learning, Synthesis: Smart, Synthesis: Strong, Synthesis: Cool, Synthesis: Collection, Synthesis: Hot"]);
...
function useDefaultFamiliar() {
  ...
  if (defaultFamiliarEquipment !== (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject3()) && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)(defaultFamiliarEquipment) > 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)(defaultFamiliarEquipment);
  }
}

function summonBrickoOyster(maxSummons) {
  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_brickoFights') >= 3) return false;
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject4())) > 0) return true;

  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('libramSummons') < maxSummons && ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject5())) < 1 || (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject6())) < 8)) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject7()));
  }

  return (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(8, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject8()));
}

function fightSausageIfGuaranteed() {
  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.sausageFightGuaranteed)()) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject9()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject10()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject11()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject12()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject13()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject14()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject15()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject16()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject17()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject18()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject19()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject20()));
    useDefaultFamiliar();
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureKill)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject21()));
  }
}
...
var synthesisPlanner = new _synthesis__WEBPACK_IMPORTED_MODULE_5__.SynthesisPlanner((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effects)(_templateObject22())); // Don't buy stuff from NPC stores.
...
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('council.php'); // All combat handled by our consult script (hccs_combat.ash).

(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('ccs bean-hccs'); // Turn off Lil' Doctor quests.

(0,_lib__WEBPACK_IMPORTED_MODULE_4__.setChoice)(1340, 3); // Default equipment.

(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject23()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject24()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject25()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject26()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject27()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject28()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject29()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject30()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject31()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject32()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject33()));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject34()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject35()));

if (!testDone(Test.COIL_WIRE)) {
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.setClan)('Bonus Adventures from Hell');

  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_clanFortuneConsultUses') < 3) {
    while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_clanFortuneConsultUses') < 3) {
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myLevel)() === 1 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.mySpleenUse)() === 0) {
    while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_universeCalculated') < (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('skillLevel144')) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('numberology 69');
    }
  } // Chateau juice bar


  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=chateau&action=chateau_desk2');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject36())); // Sell pork gems + tent

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('tutorial.php?action=toot');
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryUse)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject37()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryUse)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject38()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject39()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject40()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject41())); // Buy toy accordion

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject42()));
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.runChoice)(4); // Vote.

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=town_right&action=townright_vote');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('choice.php?option=1&whichchoice=1331&g=2&local%5B%5D=2&local%5B%5D=3'); // Make sure initiative-tracking works.

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=town_right&action=townright_vote'); // Pantogram.
  // Hilarity is better for later farming than NC

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject43())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('pantogram mysticality|hot|drops of blood|hilarity|your dreams|silent');
  } // Put on some regen gear


  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject44()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject45()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject46()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject47()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject48()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject49()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject50()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject51()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject52()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject53()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject54()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject55()));

  if (defaultFamiliar === (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject56()) && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_sausageFights') === 0) {
    useDefaultFamiliar();
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.retrieveItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject57()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject58()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject59()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureMpTonic)(30);
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject60()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.kill());
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureCreateItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject61()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject62())); // QUEST - Coil Wire
...
if (!testDone(Test.HP)) {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject63())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=campaway&action=campaway_sky');
  }

  var lovePotion = (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject64());
  var loveEffect = (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject65());
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)(loveEffect) === 0) {
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)(lovePotion) === 0) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject66()));
    }
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject67())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject68()));
  } // Boxing Daycare


  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject69())); // Cast inscrutable gaze

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject70())); // Shower lukewarm

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject71())); // Beach Comb

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject72())); // Configure briefcase

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('briefcase enchantment weapon hot -combat');

  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_kgbClicksUsed') < 20) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('briefcase buff random');
  } // Depends on Ez's Bastille script.


  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('bastille myst brutalist');
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('_horsery') !== 'crazy horse') (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('horsery crazy');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject73()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject74()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject75()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject76()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject77()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject78()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject79()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject80()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject81()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject82()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject83()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject84()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('terminal educate portscan');

  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_brickoFights') === 0 && summonBrickoOyster(7) && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject85())) > 0) {
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject86())) > 0) throw 'We should not have a bag yet.';
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject87()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject88()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject89()));
    ...
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureMpTonic)(32);
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_MACRO, _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject90())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject91())) // NEXT FIGHT PREPPED
    .kill().toString());
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject92()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject93()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_NULL);
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject94()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject95()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject96())) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject97())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject98()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject99()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.setChoice)(1387, 3); // Force drop items.

    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject100()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject101())));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject102()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject103()));
  ...
  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_candySummons') === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject104()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject105()));
  synthesisPlanner.synthesize((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject106()));
  synthesisPlanner.synthesize((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject107()));

  if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('mysticality experience percent')) < 100) {
    throw 'Insufficient +stat%.';
  } // Use ten-percent bonus


  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryUse)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject108()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject109()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject110()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject111()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject112())); // Beach Comb - should bridge all the way to spell dmg.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject113()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureNpcEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject114()), 5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject115())); // Plan is for these buffs to fall all the way through to item -> hot res -> fam weight.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject116()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject117()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject118())); // Chateau rest

  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('timesRested') < 3) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=chateau&action=chateau_restbox');
  }

  while (summonBrickoOyster(12) && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject119())) > 0) {
    useDefaultFamiliar();
    ...
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureMpTonic)(32);
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_MACRO, _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject120())).kill().toString());
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject121()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject122()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_NULL);
  } // Chateau rest


  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('timesRested') < (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.totalFreeRests)()) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=chateau&action=chateau_restbox');
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject123())); // Should be 50% myst for now.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject124()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject125()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject126())); // ensurePullEffect($effect`Perspicacious Pressure`, $item`pressurized potion of perspicacity`);
  ...
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSewerItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject127()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSewerItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject128())); // Breakfast:
  ...
  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_genieWishesUsed') < 3) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('genie wish for more wishes');
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject129()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject130()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject131()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject132()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject133()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject134()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject135()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject136()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(3, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject137()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(3, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject138())); // Don't use Kramco here.

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject139()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject140())); // Tomato in pantry (Saber YR)

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject141())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject142())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject143())) === 0 && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_monstersMapped') < 3 && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_snokebombUsed') < 3) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('mood apathetic');
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject144()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject145()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject146()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject147()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject148()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject149()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject150()));

    try {
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_MACRO, _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.pickpocket().skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject151())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject152())).toString());

      while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject153())) === 0 && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_monstersMapped') < 3 && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_snokebombUsed') < 3) {
        (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureMpTonic)(50); // For Snokebomb.

        (0,_lib__WEBPACK_IMPORTED_MODULE_4__.mapMonster)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject154()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject155()));
  ...
  var missingOintment = (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject156())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject157())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject158())) === 0;
  var missingOil = (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject159())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject160())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject161())) === 0;

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myClass)() !== (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$class)(_templateObject162()) && (missingOil || missingOintment)) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('mood apathetic');

    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('questM23Meatsmith') === 'unstarted') {
    ...
    if (!(0,canadv_ash__WEBPACK_IMPORTED_MODULE_0__.canAdv)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject163()), false)) throw 'Cannot open skeleton store!';
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.adv1)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject164()), -1, '');

    if (!(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.containsText)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject165()).noncombatQueue, 'Skeletons In Store')) {
      throw 'Something went wrong at skeleton store.';
    }

    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.findMonsterSaberYr)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject166()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject167()));
  }

  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('hasRange')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject168()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject169()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject170())) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject171())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject172()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject173()));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject174()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject175()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject176())) === 0) {
    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_reflexHammerUsed') >= 3) throw 'Out of reflex hammers!';
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject177()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject178()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject179()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject180()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject181())));
  } // Equip makeshift garbage shirt


  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('fold makeshift garbage shirt');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject182()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('mood hccs'); // LOV Tunnel

  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_loveTunnelUsed')) {
    useDefaultFamiliar();
    var macro = _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.mIf(_combat__WEBPACK_IMPORTED_MODULE_3__.Macro.monster((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject183())), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.attack()).mIf(_combat__WEBPACK_IMPORTED_MODULE_3__.Macro.monster((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject184())), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skillRepeat((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject185()))).mIf(_combat__WEBPACK_IMPORTED_MODULE_3__.Macro.monster((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$monster)(_templateObject186())), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.pickpocket().kill());
    ...
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject187()), macro);
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.handlingChoice)()) throw 'Did not get all the way through LOV.';
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('choice.php');
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.handlingChoice)()) throw 'Did not get all the way through LOV.';
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.itemAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject188())) > 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject189()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject190())); // Professor 9x free sausage fight @ NEP

  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.sausageFightGuaranteed)()) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject191()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryEquip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject192()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject193()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject194()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject195()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject196()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject197()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject198()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject199()));

    while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.sausageFightGuaranteed)()) {
      if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myHp)() < 0.8 * (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMaxhp)()) {
        (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('clan_viplounge.php?where=hottub');
      } // Just here to party.


      (0,_lib__WEBPACK_IMPORTED_MODULE_4__.setChoice)(1322, 2);
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject200()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.mIf('!monstername "sausage goblin"', new _combat__WEBPACK_IMPORTED_MODULE_3__.Macro().step('abort')).skill(Skill.get('Lecture on Relativity')).kill());
    }
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMeat)() > (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.npcPrice)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject201())) + 7 * (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.npcPrice)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject202()))) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureAsdonEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject203()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject204()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject205()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject206()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject207()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject208()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject209()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject210()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject211()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject212()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject213()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject214()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject215())) > 0) {
  ...
  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_godLobsterFights') < 2) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject216()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.setProperty)('choiceAdventure1310', '1');

    while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_godLobsterFights') < 2) {
      (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryEquip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject217()));
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('main.php?fightgodlobster=1');
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_MACRO, _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.kill().toString());
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.runCombat)();
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('choice.php');
  ...
  useDefaultFamiliar(); // 17 free NEP fights

  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_neverendingPartyFreeTurns') < 10 || (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveSkill)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject218())) && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_chestXRayUsed') < 3 || (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveSkill)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject219())) && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_shatteringPunchUsed') < 3 || (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveSkill)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject220())) && !(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_gingerbreadMobHitUsed') || (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getCampground)()['Asdon Martin keyfob'] !== undefined && !(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_missileLauncherUsed')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureNpcEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject221()), 5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject222()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject223()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject224()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('mood execute'); // NEP noncombat. Fight.

    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.setChoice)(1324, 5);
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureMpSausage)(100);

    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_neverendingPartyFreeTurns') < 10) {
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureKill)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject225()));
    } else {
      if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_missileLauncherUsed')) {
        (0,_lib__WEBPACK_IMPORTED_MODULE_4__.fuelAsdon)(100);
      }

      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureIfFree)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject226()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.kill(), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.freeKill());
    }
  } // Spend our free runs finding gobbos. We do this in the Haiku Dungeon since there is a single skippable NC.


  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject227()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryEquip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject228()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryEquip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject229()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject230()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject231()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject232()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject233()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject234()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject235()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject236()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject237()));

  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_banderRunaways') < (0,_lib__WEBPACK_IMPORTED_MODULE_4__.myFamiliarWeight)() / 5 && !(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('latteUnlocks').includes('chili')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureOde)(1);
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureRunUnlessFree)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject238()));
  }

  while ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_banderRunaways') < (0,_lib__WEBPACK_IMPORTED_MODULE_4__.myFamiliarWeight)() / 5 && !(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('latteUnlocks').includes('carrot')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureOde)(1);
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureRunUnlessFree)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject239()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('latteUnlocks').includes('chili') && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('latteUnlocks').includes('carrot') && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_latteRefillsUsed') === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('latte refill pumpkin chili carrot');
  }
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.setLocation)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject240()));
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myClass)() === (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$class)(_templateObject241())) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject242()));else (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject243()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject244())); // ensure_effect($effect[Gr8ness]);
  // ensureEffect($effect`Tomato Power`);

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject245()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject246()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject247()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject248()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject249()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject250()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureNpcEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject251()), 5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject252()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject253()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('hp', false); // QUEST - Donate Blood (HP)

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMaxhp)() - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject254())) - 3 < 1770) {
    synthesisPlanner.synthesize((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject255()));

    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMaxhp)() - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject256())) - 3 < 1770) {
...
if (!testDone(Test.MUS)) {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myClass)() === (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$class)(_templateObject257())) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject258()));else (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject259()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject260()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject261()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject262()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject263()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject264()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject265()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject266()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject267()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject268()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureNpcEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject269()), 5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject270()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('retrocape muscle');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('muscle', false);

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject271())) - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBasestat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject272())) < 1770) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject273())); // will stay on all the way to weapon damage.

    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject274())) - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBasestat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject275())) < 1770) {
      (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject276()));

      if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject277())) - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBasestat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject278())) < 1770) {
...
if (!testDone(Test.MYS)) {
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject279()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject280()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject281()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject282()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject283())); // ensureEffect($effect`Tomato Power`);

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject284()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureNpcEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject285()), 5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject286()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('retrocape mysticality');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('mysticality', false);

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject287())) - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBasestat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject288())) < 1770) {
...
if (!testDone(Test.MOX)) {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myClass)() === (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$class)(_templateObject289())) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject290()));else (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject291()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject292())); // Beach Comb

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject293()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject294()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject295()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject296()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject297()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject298()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject299()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject300())); // ensureEffect($effect`Tomato Power`);

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureNpcEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject301()), 5, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject302()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject303())), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject304()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject305())) === 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryUse)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject306()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('retrocape moxie');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('moxie', false);

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject307())) - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBasestat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject308())) < 1770) {
    synthesisPlanner.synthesize((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject309()));

    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBuffedstat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject310())) - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myBasestat)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$stat)(_templateObject311())) < 1770) {
...
if (!testDone(Test.ITEM)) {
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureMpSausage)(500);
  fightSausageIfGuaranteed();

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject312())) === 0) {
    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_reflexHammerUsed') >= 3) throw 'Out of reflex hammers!';
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject313()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject314()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject315()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject316()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject317())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject318())));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.tryUse)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject319()));

  if (![0, 5].includes((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myInebriety)())) {
    throw 'Too drunk. Something went wrong.';
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureOde)(5 - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myInebriety)());
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.drink)(5 - (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myInebriety)(), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject320())); // Tune moon sign to Opossum.

  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('moonTuned')) {
    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_campAwaySmileBuffs') === 0) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=campaway&action=campaway_sky');
    } // Unequip spoon.


    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject321()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject322()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject323()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject324()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject325()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject326())); // Actually tune the moon. To Opossum.

    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('inv_use.php?whichitem=10254&doit=96&whichsign=5');
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject327()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject328()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject329()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject330()));
  synthesisPlanner.synthesize((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject331()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getCampground)()['Asdon Martin keyfob']) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureAsdonEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject332()));
  } else {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject333()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject334()));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject335())); // bag of grain
  // Visiting the Ruined House

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject336()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=desertbeach&action=db_nukehouse');
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject337())); // government

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject338()));

  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_campAwaySmileBuffs') === 1) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=campaway&action=campaway_sky');
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject339()));
  ...
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.wishEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject340()));

  var itemTurns = function itemTurns() {
  ...
  if (itemTurns() > 1 && !(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_clanFortuneBuffUsed')) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.print)('Not enough item drop, using fortune buff.');
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject341()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.print)("Estimated item turns: ".concat(itemTurns()));
...
if (!testDone(Test.HOT_RES)) {
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject342()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject343()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject344()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject345()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject346()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject347()));
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject348())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('mood apathetic');
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject349()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.setProperty)('choiceAdventure1387', '3');
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject350()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject351()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject352())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject353())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject354())));
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject355())) > 0) (0,_lib__WEBPACK_IMPORTED_MODULE_4__.incrementProperty)('_meteorShowerUses');
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject356())) === 0) {
    synthesisPlanner.synthesize((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject357()));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject358()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject359()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject360())); // Pool buff. This will fall through to fam weight.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject361()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject362()));
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(10, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject363()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(10, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject364()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject365())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject366()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject367())) > 0 || (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject368())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject369()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject370()));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject371()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject372())); // Build up 100 turns of Deep Dark Visions for spell damage later.

  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveSkill)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject373())) && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject374())) < 80) {
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMp)() < 20) {
      (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureCreateItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject375()));
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.eat)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject376()));
    }

    while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myHp)() < (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMaxhp)()) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject377()));
    }

    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMp)() < 100) {
      (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureCreateItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject378()));
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.eat)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject379()));
    }

    if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('spooky resistance')) < 10) {
      (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject380()));
    ...
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject381()));
  } // Beach comb buff.


  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject382())); // Use pocket maze

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject383())) > 0) (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject384()));
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getCampground)()['Asdon Martin keyfob']) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureAsdonEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject385()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject386()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject387())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.retrieveItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject388()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject389()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject390()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('retrocape vampire hold'); // Mafia sometimes can't figure out that multiple +weight things would get us to next tier.

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('hot res, 0.01 familiar weight', false); // OK to waste a couple turns here

  if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('hot resistance')) + 9 <= 62) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject391()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject392()));
  }

  if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('hot resistance')) + 5 <= 60) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject393()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject394()));
  }

  if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('hot resistance')) < 58) {
    throw 'Something went wrong building hot res.';
  }

  doTest(Test.HOT_RES);
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject395()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.autosell)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject396()));
}

if (!testDone(Test.NONCOMBAT)) {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myHp)() < 30) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject397()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject398()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject399()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject400()));

  if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_godLobsterFights') < 3) {
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myHp)() < 0.8 * (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myMaxhp)()) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject401()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject402())); // Get -combat buff.

    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.setProperty)('choiceAdventure1310', '2');
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject403()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('main.php?fightgodlobster=1');
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_MACRO, _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.kill().toString());
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.runCombat)();
  ...
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject404()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject405()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject406()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject407()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject408()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject409()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject410()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getCampground)()['Asdon Martin keyfob']) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureAsdonEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject411()));
  } else {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.wishEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject412()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject413()));
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('_horsery') !== 'dark horse') (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('horsery dark'); // Pastamancer d1 is -combat.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject414()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject415()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)("-combat, 0.01 familiar weight, equip Kremlin's Greatest Briefcase", false); // Rewards

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject416()));

  if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('combat rate')) > -40) {
...
if (!testDone(Test.FAMILIAR)) {
  ...
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject417()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject418())); // Pool buff.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject419()));
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myHp)() < 30) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject420()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject421()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject422()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject423()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject424())) > 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject425()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject426()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject427())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject428()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject429()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject430()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject431())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject432())));
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject433())) > 0) (0,_lib__WEBPACK_IMPORTED_MODULE_4__.incrementProperty)('_meteorShowerUses');
  } // NC reward


  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject434()));
  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_clanFortuneBuffUsed')) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('fortune buff familiar');
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.pullIfPossible)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject435()), 0);
...
if (!testDone(Test.WEAPON)) {
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject436())) === 0) {
    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_reflexHammerUsed') >= 3) throw 'Out of reflex hammers!';
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject437()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject438()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject439()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject440()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject441())));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject442())) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject443())) === 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject444()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject445()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject446()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.setChoice)(768, 4); // Make mini-adv a Sauceror.

    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('miniAdvClass') !== 4) {
      if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_kgbTranquilizerDartUses') >= 3) throw 'Out of tranquilizer darts!';
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject447()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject448())));
    }

    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_kgbTranquilizerDartUses') >= 3) throw 'Out of tranquilizer darts!';
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject449()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject450())));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject451())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject452()));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject453()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject454()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject455()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject456()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject457()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject458()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject459()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject460()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject461())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject462()));
  } // Hatter buff


  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_madTeaParty')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject463()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject464()));
  } // Beach Comb
  ...
  if (!(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.containsText)((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('_beachHeadsUsed'), '6')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject465()));
  } // Pool buff. Should have fallen through.


  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject466()));
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject467())) > 0) (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject468())); // Pastamancer d1 is weapon damage.

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject469())); // ensureNpcEffect($effect`Engorged Weapon`, 1, $item`Meleegra™ pills`);
  ...
  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_chateauMonsterFought')) {
    var chateauText = (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=chateau', false);
    var match = chateauText.match(/alt="Painting of an? ([^(]*) .1."/);
    if ((0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('camelSpit') === 100) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject470()));

    if (match && match[1] === 'ungulith') {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('mood apathetic');
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject471()));
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.setMode)(_combat__WEBPACK_IMPORTED_MODULE_3__.MODE_MACRO, _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject472())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject473())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject474())).toString());
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.setProperty)('choiceAdventure1387', '3');
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('place.php?whichplace=chateau&action=chateau_painting', false);
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.runCombat)();
      (0,_combat__WEBPACK_IMPORTED_MODULE_3__.saberYr)();
    } else {
  ...
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject475()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject476()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('weapon damage', false);

  var weaponTurns = function weaponTurns() {
    return 60 - Math.floor((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('weapon damage') / 25 + 0.001) - Math.floor((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('weapon damage percent') / 25 + 0.001);
  };

  if (weaponTurns() >= 5) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject477()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject478()));
  }

  if (weaponTurns() >= 5) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject479()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject480()));
  }

  if (weaponTurns() >= 7) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.wishEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject481()));
  }
...
if (!testDone(Test.SPELL)) {
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject482()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject483()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject484()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject485()));
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSong)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject486())); // Pool buff

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject487())); // Beach Comb

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject488())); // Tea party

  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_madTeaParty')) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureSewerItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject489()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject490()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject491()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject492())) > 0) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject493()));
  }

  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.pullIfPossible)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject494()), 0);
  (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePullEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject495()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject496()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject497()));

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject498())) === 0 && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject499())) > 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.create)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject500()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject501())) === 0 && (0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyInt)('_meteorShowerUses') < 5) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.equip)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject502()));
    (0,_combat__WEBPACK_IMPORTED_MODULE_3__.adventureMacro)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject503()), _combat__WEBPACK_IMPORTED_MODULE_3__.Macro.skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject504())).skill((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject505())));
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject506())) > 0) (0,_lib__WEBPACK_IMPORTED_MODULE_4__.incrementProperty)('_meteorShowerUses');
  } // Sigils of Yeg = 200% SD


  if (!(0,_lib__WEBPACK_IMPORTED_MODULE_4__.getPropertyBoolean)('_cargoPocketEmptied') && (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject507())) === 0) {
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject508())) === 0) (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('cargo 177');
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject509()));
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject510())) > 0) (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject511())); // Get flimsy hardwood scraps.

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.visitUrl)('shop.php?whichshop=lathe');

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject512())) > 0) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.retrieveItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject513()));
  }

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.cliExecute)('briefcase enchantment spell');
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.useFamiliar)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject514()));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.maximize)('spell damage', false);

  if (Math.round((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('spell damage percent')) % 50 >= 40) {
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensureItem)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject515()));
    (0,_lib__WEBPACK_IMPORTED_MODULE_4__.ensurePotionEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$effect)(_templateObject516()), (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject517()));
  }

  var spellTurns = function spellTurns() {
    return 60 - Math.floor((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('spell damage') / 50 + 0.001) - Math.floor((0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.numericModifier)('spell damage percent') / 50 + 0.001);
  };

  while (spellTurns() > (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.myAdventures)()) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.eat)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject518()));
  }
...
(0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.setProperty)('autoSatisfyWithNPCs', (0,kolmafia__WEBPACK_IMPORTED_MODULE_1__.getProperty)('_saved_autoSatisfyWithNPCs'));
...
function ensureSewerItem(quantity, it) {
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)(it) < quantity) {
    ensureItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject2()));
  }
}
function ensureHermitItem(quantity, it) {
  ...
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject3())) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject4())) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject5())) < count) {
    ensureItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject6()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.use)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject7()));
  }

  ensureItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject8()));
...
function ensureMpTonic(mp) {
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myMp)() < mp) {
    ensureItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject9()));
...
function ensureMpSausage(mp) {
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myMp)() < Math.min(mp, (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myMaxmp)())) {
    ensureCreateItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject11()));
...
function ensureDough(goal) {
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject13())) < goal) {
...
function fuelAsdon(goal) {
  ...
  var bread = (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject16()));
  ensureDough(estimated - bread);
  ensureItem(estimated - bread, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject17()));
  ensureCreateItem(estimated, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject18()));
  ...
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getFuel)() < goal) {
    ensureDough(1);
    ensureItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject19()));
    ensureCreateItem(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject20()));
...
function mapMonster(location, monster) {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveSkill)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject21())) && !getPropertyBoolean('mappingMonsters') && getPropertyInt('_monstersMapped') < 3) {
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useSkill)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject22()));
  }
...
var songSlots = [(0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effects)(_templateObject23()), (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effects)(_templateObject24()), (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effects)(_templateObject25()), (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effects)(_templateObject26())];
...
function ensureOde(turns) {
  while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEffect)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effect)(_templateObject27())) < turns) {
    ensureMpTonic(50);
    openSongSlot((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effect)(_templateObject28()));
    (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useSkill)(1, (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$skill)(_templateObject29()));
  }
}
...
/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib */ "./src/lib.ts");
function _templateObject8() {
  var data = _taggedTemplateLiteral(["peppermint sprout, peppermint twist"]);
...
function _templateObject6() {
  var data = _taggedTemplateLiteral(["Synthesis: Strong, Synthesis: Smart, Synthesis: Cool, Synthesis: Hardy, Synthesis: Energy"]);
...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["Synthesis: Hot, Synthesis: Cold, Synthesis: Pungent, Synthesis: Scary, Synthesis: Greasy"]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["jaba&ntilde;ero-flavored chewing gum, lime-and-chile-flavored chewing gum, pickle-flavored chewing gum, tamarind-flavored chewing gum"]);
...
var npcCandies = (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject());
  ...
  _createClass(SynthesisPlanner, [{
    ...
    value: function synthesize(effect) {
      ...
      for (var _i2 = 0, _Object$keys = Object.keys(inventory); _i2 < _Object$keys.length; _i2++) {
        ...
        if (item.candyType === 'simple' || item === (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject2())) this.simple.set(item, count);
        if (item.candyType === 'complex') this.complex.set(item, count);
      }

      if (['Wombat', 'Blender', 'Packrat'].includes((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.mySign)()) && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject3())) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject4())) > 0) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            ...
            if (npcCandies.includes(_candy)) {
              (0,_lib__WEBPACK_IMPORTED_MODULE_2__.ensureItem)(formA === formB ? 2 : 1, _candy);
            } else {
    ...
    value: function getCandyOptions(effect) {
      if ((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effects)(_templateObject5()).includes(effect)) {
        return [this.simple, this.simple];
      } else if ((0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$effects)(_templateObject6()).includes(effect)) {
...
var CANDY_FORMS = new Map([[(0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$item)(_templateObject7()), (0,libram_src__WEBPACK_IMPORTED_MODULE_1__.$items)(_templateObject8())]]);
